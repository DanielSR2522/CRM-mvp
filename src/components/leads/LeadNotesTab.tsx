    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSaveTopLevelNote} className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-5 shadow-xl space-y-4">
        ...
        <div className="flex items-center justify-end border-t border-slate-800/80 pt-3">
          <button
            type="submit"
            disabled={submitting || (!newNoteBody.trim() && selectedFiles.length === 0 && pastedPreviews.length === 0)}
            className="px-4 py-2 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-semibold shadow-lg transition-all disabled:opacity-50"
          >
