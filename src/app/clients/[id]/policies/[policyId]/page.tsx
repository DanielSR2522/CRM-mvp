          ...
          <div className="space-y-6">
            ...
            {activeMenuTab !== 'summary' ? (
              <div className="bg-white border border-slate-100 rounded-2xl p-10 text-center shadow-sm">
                ...
                <h3 className="text-base font-bold text-slate-800">Coming in the next phase</h3>
                <p className="text-slate-400 text-sm mt-1">This module is currently in development and will be activated shortly.</p>
              </div>
            ) : (
